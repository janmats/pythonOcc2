...
from OCC.Core.Graphic3d import Graphic3d_MATERIAL_ASPECT, Graphic3d_NameOfMaterial, Graphic3d_NOM_COPPER, \
    Graphic3d_MaterialAspect
from OCC.Core.gp import gp_Pnt2d, gp_XOY, gp_Lin2d, gp_Ax3, gp_Dir2d, gp_Pnt, gp_Ax2, gp_Dir
